...
function Postal_Wire:OnEnable()
	local module = self or Postal_Wire
	if module:IsHooked("onValueChangedFunc") then
		module:Unhook("onValueChangedFunc")
	end
	module:SecureHook(SendMailMoney, "onValueChangedFunc")
end
